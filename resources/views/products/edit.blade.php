                                ...
                                <div class="formGroup">
                                    ...
                                    <div class="input-area relative">
                                        <input name="title" type="text" id="title" class="form-control !pl-12"
                                               placeholder="{{ __('Enter title product') }}" value="{{ $product->title }}" required>
                                ...
                                <div class="formGroup">
                                    ...
                                    <div class="input-area relative">
                                        <input name="quantity" type="text" id="quantity" class="form-control !pl-12"
                                               placeholder="{{ __('Enter quantity product') }}" value="{{ $product->quantity }}" required>
                                        <span class="absolute left-0 top-1/2 -translate-y-1/2 w-9 h-full border-r border-r-slate-200 dark:border-r-slate-700 flex items-center justify-center dark:text-white">
                                                <iconify-icon icon="fluent-mdl2:product"></iconify-icon>
                                            </span>
                                ...
                                <div class="formGroup">
                                    ...
                                    <div class="input-area relative">
                                        <input name="period" type="text" id="period" class="form-control !pl-12"
                                               placeholder="{{ __('Enter period product') }}" value="{{ $product->period }}">
                                        <span class="absolute left-0 top-1/2 -translate-y-1/2 w-9 h-full border-r border-r-slate-200 dark:border-r-slate-700 flex items-center justify-center dark:text-white">
                                                <iconify-icon icon="fluent-mdl2:product"></iconify-icon>
                                            </span>
                                ...
                                <div class="formGroup">
                                    ...
                                    <div class="input-area relative">
                                        <input name="address" type="text" id="address" class="form-control !pl-12"
                                               placeholder="{{ __('Enter address product') }}" value="{{ $product->address }}" required>
                                        <span class="absolute left-0 top-1/2 -translate-y-1/2 w-9 h-full border-r border-r-slate-200 dark:border-r-slate-700 flex items-center justify-center dark:text-white">
                                                <iconify-icon icon="fluent-mdl2:product"></iconify-icon>
                                            </span>
                                ...
                                <div class="formGroup">
                                    ...
                                    <div class="input-area relative">
                                        <input name="description" type="text" id="description" class="form-control !pl-12"
                                               placeholder="{{ __('Enter description product') }}" value="{{ $product->description }}" required>
                                        <span class="absolute left-0 top-1/2 -translate-y-1/2 w-9 h-full border-r border-r-slate-200 dark:border-r-slate-700 flex items-center justify-center dark:text-white">
                                                <iconify-icon icon="fluent-mdl2:product"></iconify-icon>
                                            </span>
                                    ...
                                    <div class="input-area relative">
                                        <select name="product_categories_id" class="form-control !pl-12">
                                            ...
                                            @foreach($productCategories as $category)
                                                <option value="{{ $category->id }}" @selected($category->id == $product->product_categories_id)>
                                                    {{ $category->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="input-area relative">
                                        <select name="product_type_id" class="form-control !pl-12">
                                            ...
                                            @foreach($productTypes as $type)
                                                <option value="{{ $type->id }}" @selected($type->id == $product->product_type_id)>
                                                    {{ $type->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="input-area relative">
                                        <select name="owner_id" class="form-control !pl-12">
                                            ...
                                            @foreach($owners as $owner)
                                                <option value="{{ $owner->id }}" @selected($owner->id == $product->owner_id)>
                                                    {{ $owner->name }}
                                                </option>
                                            @endforeach
                                        </select>
