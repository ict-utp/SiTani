    ...
    <div>
        ...
        <div class="card">
            <div class="card-body flex flex-col p-6">
                ...
                <form method="POST" action="{{ route('product-types.update', $productType) }}" class="space-y-4">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="formGroup">
                                ...
                                <div class="input-area relative">
                                    <input name="name" type="text" id="name" class="form-control !pl-12"
                                        placeholder="{{ __('Enter name product type') }}" value="{{ $productType->name }}" required>
